    ...
    <div class="container-fluid py-4">
        <div class="card">
            ...
            <div class="card-body pt-4 p-3">
                <form action="{{ route('kelas.update', $kelas->id) }}" method="POST" role="form text-left" enctype="multipart/form-data">
                    @csrf
                    @method('PUT')
                    @if($errors->any())
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{ old('nama_kelas', $kelas->nama_kelas) }}" type="text" placeholder="Nama Kelas" name="nama_kelas">
                                @error('nama_kelas')
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input class="form-control" value="{{ old('jurusan', $kelas->jurusan) }}" type="text" placeholder="Jurusan" name="jurusan">
                                @error('jurusan')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                            </div>
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="tinkat" class="form-control">
                                    ...
                                    <option value="1" {{ old('tinkat', $kelas->tinkat) == '1' ? 'selected' : '' }}>1</option>
                                    <option value="2" {{ old('tinkat', $kelas->tinkat) == '2' ? 'selected' : '' }}>2</option>
                                    <option value="3" {{ old('tinkat', $kelas->tinkat) == '3' ? 'selected' : '' }}>3</option>
                                </select>
                                @error('tinkat')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
                                @enderror
                        ...
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <select name="id_guru" class="form-control">
                                    ...
                                    @foreach($gurus as $g)
                                        <option value="{{ $g->id }}" {{ old('id_guru', $kelas->id_guru) == $g->id ? 'selected' : '' }}>{{ $g->nama_guru }}</option>
                                    @endforeach
                                </select>
                                @error('id_guru')
                                    <p class="text-danger text-xs mt-2">{{ $message }}</p>
