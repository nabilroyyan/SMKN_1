...
<aside class="sidenav navbar navbar-vertical navbar-expand-xs border-0 border-radius-xl my-3 fixed-start ms-3 " id="sidenav-main">
  <div class="sidenav-header">
    ...
    $kelas = null;
    if (Auth::check()) {
        $kelas = Kelas::where('id_users', Auth::id())->first();
    }
@endphp
    <div class="w-auto" id="sidenav-collapse-main">
    <i class="fas fa-times p-3 cursor-pointer text-secondary opacity-5 position-absolute end-0 top-0 d-none d-xl-none" aria-hidden="true" id="iconSidenav"></i>
    <a class="align-items-center d-flex m-0 navbar-brand text-wrap" href="{{ route('dashboard') }}">
        <img src="{{ asset('img/logo_smk-removebg-preview.png') }}" class="navbar-brand-img h-100" alt="...">
        <span class="ms-3 font-weight-bold">SMKN 1 Suemenep</span>
    </a>
  </div>
  <hr class="horizontal dark mt-0">
    <ul class="navbar-nav">
      ...
      <li class="nav-item mt-2">
        <h6 class="ps-4 ms-2 text-uppercase text-xs font-weight-bolder opacity-6">Data Fungsional</h6>
      </li>
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('superadmin/user/index') ? 'active' : '') }}" href="{{ url('superadmin/user/index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('superadmin/siswa/index') ? 'active' : '') }}" href="{{ url('superadmin/siswa/index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                   <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>siswa</title>
                    <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('superadmin/guru/index') ? 'active' : '') }}" href="{{ url('superadmin/guru/index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                   <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>guru</title>
                    <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
      ...
      <li class="nav-item pb-2">
        <a class="nav-link {{ (Request::is('superadmin/jurusan/index') ? 'active' : '') }}" href="{{ url('superadmin/jurusan/index') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
                   <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                    <title>jurusan</title>
                    <g id="Basic-Elements" stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Jueusan</span>
        </a>
      </li>
      <li class="nav-item pb-2">
      ...
      <li class="nav-item mt-2">
        ...
        <li class="nav-item">
          <a class="nav-link {{ Request::is('superadmin/skor-pelanggaran/index') ? 'active' : '' }}" href="{{ url('superadmin/skor-pelanggaran/index') }}">
            ...
            <span class="nav-link-text ms-1">Kategori pelanggaran</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Request::is('superadmin/catatan-pelanggaran/index') ? 'active' : '' }}" href="{{ url('superadmin/catatan-pelanggaran/index') }}">
            ...
            <span class="nav-link-text ms-1">Catatan Pelanggaran</span>
          </a>
        </li>
        <li class="nav-item">
          <a class="nav-link {{ Request::is('superadmin/monitoring-pelanggaran/index') ? 'active' : '' }}" href="{{ url('superadmin/monitoring-pelanggaran/index') }}">
            ...
            <span class="nav-link-text ms-1">Monitoring Pelanggaran</span>
          </a>
        </li>
      </li>
      <li class="nav-item mt-2">
        ...
        <li class="nav-item">
          ...
          <a class="nav-link {{ Route::is('absensi.catatan') && request('kelas_id') == $kelas->id ? 'active' : '' }}" href="{{ route('absensi.catatan', ['kelas_id' => $kelas->id]) }}">
                  ...
                  <span class="nav-link-text ms-1">Catatan Absensi</span>
              </a>
          @endif
      </li>
        ...
        <li class="nav-item">
          ...
          <a class="nav-link {{ Request::routeIs('absensi.validasi') && request('kelas_id') == $kelas->id ? 'active' : '' }}" href="{{ route('absensi.validasi', ['kelas_id' => $kelas->id]) }}">
            ...
            <span class="nav-link-text ms-1">Verifikasi Absensi</span>
            @endif
          </a>
      
        </li>
        <li class="nav-item">
          <a class="nav-link {{ (Request::is('superadmin/absensi/monitoring-absensi') ? 'active' : '') }}" href="{{ url('superadmin/absensi/monitoring-absensi') }}">
            <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
              <svg width="12px" height="12px" viewBox="0 0 46 42" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
                <title>Monitoring</title>
                <g stroke="none" stroke-width="1" fill="none" fill-rule="evenodd">
            ...
            <span class="nav-link-text ms-1">Monitoring Absensi</span>
          </a>
        </li>
      </li>
      @endif
      @if (Auth::user() && Auth::user()->role === 'tatip')
      <li class="nav-item">
        <a class="nav-link {{ (Request::is('dashboard') ? 'active' : '') }}" href="{{ url('dashboard') }}">
          <div class="icon icon-shape icon-sm shadow border-radius-md bg-white text-center me-2 d-flex align-items-center justify-content-center">
            <svg width="12px" height="12px" viewBox="0 0 45 40" version="1.1" xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink">
